<nav x-data="{ open: false }" class="bg-[#0f1122]/60 backdrop-blur-xl border border-white/5 relative z-50 rounded-b-2xl shadow-[0_4px_30px_rgba(0,0,0,0.3)] mx-2">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-3 transition-transform hover:scale-105">
                        <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center shadow-[0_0_15px_rgba(147,51,234,0.5)] border border-white/20">
                            <svg class="w-5 h-5 text-white drop-shadow-[0_0_8px_rgba(255,255,255,0.8)]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                        </div>
                        <span class="text-xl font-black tracking-widest text-white drop-shadow-[0_0_8px_rgba(255,255,255,0.3)] uppercase">SupportHub</span>
                    </a>
                </div>
