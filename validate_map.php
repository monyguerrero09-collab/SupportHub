<?php
$html = file_get_contents('c:\\Users\\monyg\\OneDrive\\Documentos\\ticket_plataforma\\resources\\views\\livewire\\station-map.blade.php');
...
if (empty($errors)) {
    ...
    foreach ($errors as $error) {
        if ($error->code == 801) continue; // Tag unrecognized
